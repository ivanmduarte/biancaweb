                    ...
                    <div className="mt-3 p-3">
                        <div className="row featurette">
                            ...
                            <div className="col-md-5 order-md-1">
                                <img src={'../BiancaEugenio1.jpg'} className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto rounded-circle" width="300" height="300"></img>   
                            </div>
                        </div>
                    </div>
                </div>
